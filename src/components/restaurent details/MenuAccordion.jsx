...
import ReplaceCartModal from "../cart/ReplaceCartModal";

const MenuAccordion = ({ menu = [], restaurantName, restaurantId }) => {
  const { addItem, isDifferentRestaurant, cartRestaurantName, clearCart } = useCart();
  ...
  const handleConfirmReplace = () => {
    clearCart(); // ✅ now correctly dispatches
    if (pendingItem) {
      addItem(pendingItem);
    }
    setPendingItem(null);
